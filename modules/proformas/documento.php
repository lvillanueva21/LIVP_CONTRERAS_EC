...
$titulo = $proforma ? 'Proforma ' . $proforma['codigo'] : 'Proforma';
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body class="pf-documento-body">
    <div class="pf-documento-actions">
    ...
    <div class="pf-documento-page">
        <?php echo pf_render_documento($id); ?>
    </div>
</body>
</html>